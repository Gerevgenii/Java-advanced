...
//    <td>{level}</td>
    ...
    private final Map<String, App> apps = new TreeMap<>(Map.ofEntries(
            app("Client 1", "java", "-cp", CLASSPATH, "info.kgeorgiy.ja.gerasimov.bank.Client", "name", "surname", "111111", "1", "500"),
            app("Client 2", "java", "-cp", CLASSPATH, "info.kgeorgiy.ja.gerasimov.bank.Client", "name1", "surname1", "222222", "2", "600"),
            app("Client 3", "java", "-cp", CLASSPATH, "info.kgeorgiy.ja.gerasimov.bank.Client", "name2", "surname2", "333333", "3", "700"),
            app("Server 1", "java", "-cp", CLASSPATH, "info.kgeorgiy.ja.gerasimov.bank.Server", "8881"),
            app("Server 2", "java", "-cp", CLASSPATH, "info.kgeorgiy.ja.gerasimov.bank.Server", "8882"),
